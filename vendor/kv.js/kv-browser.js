/**
 * kv-browser.js — HeyPuter/kv.js browser bundle for GOAR
 * Upstream: https://github.com/HeyPuter/kv.js (MIT)
 * Exposes: window.kvjs (constructor)
 */
(function (global) {
  "use strict";
  var __modules = {};
  function require(id) {
    if (id === "./XMap.js" || id === "./XMap") return __modules.XMap;
    throw new Error("kv-browser: unknown require " + id);
  }
  // ---- XMap ----
  (function () {
    var module = { exports: {} };
